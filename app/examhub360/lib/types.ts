export interface D360User { id: string; name: string; email: string; role: string; firstName?: string; lastName?: string; phone?: string; college?: string; state?: string; is_paid?: boolean; isPaid?: boolean; }
